...
insert into registeredUser(username, password, name, surname, email, address, city, country, phone, role_id, enabled) values ('mkisic', '$2a$10$UVn74F/yEiUzKWBSGVyzHe2UfpVJ95zY50Q8bz1RFyrAYVfwFAj4i', 'Mihajlo', 'Kisic', 'pecurka@gmail.com', 'Strazilovska 27', 'Novi Sad', 'Serbia', '333555', 3, true);
...
values (nextval('reservation_id_seq'), 'COTTAGE', 'Silver Mirror', 'Piwneuh', 'imbiamba', '2022-04-09', '2022-04-21', 'wifi', 1, false, false, 300, false, false, 0);

insert into reservation(id, type, name, ownerUsername, customerUsername, startTime, endTime, additionalServices, guests, isCancelled, isDeal, price, isReviewed, complaintExists, salePercent)
values (nextval('reservation_id_seq'), 'COTTAGE', 'Prvenstvo Srbije', 'Piwneuh', 'imbiamba', '2022-06-18', '2022-06-19', 'wifi', 1, false, false, 35, false, false, 0);
