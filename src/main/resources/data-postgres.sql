...
insert into adventure(id, name, country, city, address, promo_description, capacity, rules, price, additional_services, cancellation_fee, instructor_bio, fishing_equipment, owner_username)
values (nextval('rentable_id_seq'), 'Silver Mirror Tour', 'Serbia', 'Srebrno Jezero', 'Random ulica', 'See your reflection', 4, 'Be polite.', 50, 'snacks=15;', 0, 'Ambitious and carefree adventurer', 'Fishing lines, hooks, rigs, bait', 'Fishdude');
...
insert into cottage(id, name, country, city, address, promo_description, capacity, rules, price, additional_services, cancellation_fee, rooms, beds_per_room, owner_username, images)
values (nextval('rentable_id_seq'), 'Black Mirror', 'Serbia', 'Srebrno Jezero', 'Random ulica', 'See your reflection', 8, 'Be polite.', 40, 'wifi=5;chocolate=3', 0, 3, 2, 'Piwneuh', 'c5.1.jpg;c5.2.jpg;c5.3.jpg');
...
insert into free_term(id, type, entity_name, owner_username, start_time, end_time) values (nextval('reservation_id_seq'), 'COTTAGE', 'Silver Mirror', 'Piwneuh', '2022-01-07', '2022-01-27');
insert into free_term(id, type, entity_name, owner_username, start_time, end_time) values (nextval('reservation_id_seq'), 'BOAT', '380 Realm Boston Whaler', 'Popaye', '2022-01-07', '2022-01-09');
insert into free_term(id, type, entity_name, owner_username, start_time, end_time) values (nextval('reservation_id_seq'), 'ADVENTURE', 'Silver Mirror Tour', 'Fishdude', '2022-01-15', '2022-01-27');

insert into reservation(id, type, name, owner_username, customer_username, start_time, end_time, additional_services, guests, is_cancelled, is_deal, price, rating, complaint_exists)
values (1, 'COTTAGE', 'Silver Mirror', 'Piwneuh', 'imbiamba', '2022-01-08', '2022-01-21', 'Some services', 1, false, false, 10000, 0, false);